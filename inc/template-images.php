...
if ( ! function_exists( 'magnitude_post_thumbnail' ) ) :
    /**
     ...
     */
    function magnitude_post_thumbnail() {
        ...
        if ( is_singular() ) :
            ...
            $theme_class = magnitude_get_option('global_image_alignment');
            $post_image_alignment = get_post_meta($post->ID, 'magnitude-meta-image-options', true);
            ...
            if ( $post_class != 'no-image' ):
                ...
                <div class="post-thumbnail <?php echo esc_attr($post_class); ?>">
                    <?php the_post_thumbnail('magnitude-featured'); ?>
                </div>
            <?php endif; ?>
        ...
        <?php else :
            ...
            if ($archive_layout == 'archive-layout-list') {
                $archive_image_alignment = magnitude_get_option('archive_image_alignment');
                $archive_class = $archive_image_alignment;
                $archive_image = 'medium';
            } elseif ($archive_layout == 'archive-layout-full') {
                $archive_image = 'magnitude-medium';
            } else {
