...
<?php if (is_singular()) : ?>
    <div class="color-pad">
        <div class="entry-content read-details pad ptb-10">
            ...
            <?php if (is_single()): ?>
                <p><em>Теперь следить за нашими публикациями можно в <a href="https://news.google.com/publications/CAAqJQgKIh9DQklTRVFnTWFnMEtDMmwwYm1SaGFXeDVMbkoxS0FBUAE?hl=ru&amp;gl=RU&amp;ceid=RU%3Aru">Google Новостях</a>, а прямую речь Главреда, комментарии и самые интересные посты вы найдете в <a href="https://t.me/itndailyru">Telegram</a>>.</em></p>
